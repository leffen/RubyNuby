#!/usr/local/bin/ruby
# Ruby¥¹¥¯¥ê¥×¥È¡¤Java¥½¡¼¥¹¡¤C++¥½¡¼¥¹¤òHTML¤ËÀ°·Á¤¹¤ë
# ¥­¡¼¥ï¡¼¥É¡¤¥³¥á¥ó¥È¡¤Ê¸»úÎó¤Ë¿§¤òÉÕ¤±¤ë

# Copyright (c) 2001 HORIKAWA Hisashi. All rights reserved.
#   mailto:vzw00011@nifty.ne.jp
#   http://www2.airnet.ne.jp/pak04955/

# Modification based on rb2html.rb to implement
# HTML subsections with some differences to better suit the
# presentation material 

require File.expand_path('rb2htmlz-sub.rb', File.dirname(__FILE__))

class Ruby2Html < HtmlFormat
  def initialize()
    super()
  ...
  def state1(ch)
    ...
    when '<'
      if @line[0, 1] == '<' && @line[1, 1] == '\''
        ...
        print html_escape(@line.shift) # tail¤Î¸å¤í¤Î'
        return
